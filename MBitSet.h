...
static inline int countint32(const uint32_t &v) {
...
static inline int countint64(const uint64_t &v) {
...
class MBitSet32 {
private:
	int n, m; //n number of intnt64, m the number of valid bits in the last int
